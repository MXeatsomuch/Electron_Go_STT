...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  saveRecording: () => ipcRenderer.send('save-recording'), //record.html 中保存录音
  ...
  saveTextToPDF: (text) => ipcRenderer.send('save-text-to-pdf', text), //filetotext.html和realtime-stt.html 中保存文字到PDF
